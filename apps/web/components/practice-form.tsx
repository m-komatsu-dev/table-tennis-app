...
export function PracticeForm({
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <Field label="場所">
        <input className={inputClass} defaultValue={practice?.location ?? ""} name="location" />
      </Field>
      <Field label="使用用具">
      ...
      <Field label="練習内容メモ">
        <textarea className={inputClass} defaultValue={practice?.content ?? ""} name="content" rows={7} />
      </Field>
