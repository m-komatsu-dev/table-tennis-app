...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "ユーザーが登録する情報：練習記録、試合記録、練習メニュー、用具情報、練習内容や課題メモ、募集内容、参加希望、チャットメッセージ、通報内容、フィードバック内容、ブロック情報、公開設定、アプリ内通知の表示状態、チャット未読・既読管理情報。",
  ...
  },
  {
    ...
    table: [
      ...
      ["Supabase / PostgreSQL", "データベース保存", "アカウント情報、記録、募集、チャット、通報、フィードバック、ブロック等"],
  ...
  },
  {
    title: "10. 保存期間",
    body: [
      "登録情報、記録、募集、チャット、通報、フィードバック、ブロック等は、アカウントが存在する間、またはサービス提供、不正利用対策、障害対応、法令上必要な期間、保存される場合があります。",
      "ログイン後、プロフィール内の「アカウントを削除する」からアカウント削除を行った場合、当該アカウントに紐づくプロフィール、卓球記録、用具、練習メニュー、募集、参加希望、チャット、通知、ブロック、通報、フィードバック等を削除します。",
      "Googleログインを利用している場合でも、削除対象はTable Tennis Logとの連携情報であり、Googleアカウントそのものは削除されません。",
      "具体的な保存日数は現在の実装では定めていません。法令上の必要性、セキュリティ対応、システムのバックアップ、ホスティングや実行基盤のログ等により、一部の情報が削除依頼やアカウント削除後も直ちに完全消去されない場合があります。"
    ]
  },
  {
    ...
    body: [
      ...
      "アカウント削除は、ログイン後のプロフィール内にある「アカウントを削除する」から行えます。",
      "その他の問い合わせについて、現在のβ版では、ログイン済みユーザー向けのフィードバック機能を問い合わせ窓口としています。",
      "本サービスに関するご意見、不具合報告、個人情報に関するお問い合わせは、ログイン後のフィードバック画面から送信できます。",
      "ログインしていない方からの問い合わせ窓口は正式公開までに整備します。本人確認が必要な開示・削除等の問い合わせについては、フィードバック送信後に追加確認を行う場合があります。"
    ]
  },
  {
    title: "12. 未成年者",
