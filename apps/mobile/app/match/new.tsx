...
import { Button, Card, ErrorMessage, Header, Screen, SectionTitle, Segment, TextField, colors, styles } from "@/components/ui";
...
export default function NewMatchScreen() {
  ...
  const [scores, setScores] = useState<ScoreInputRow[]>(initialScores);
