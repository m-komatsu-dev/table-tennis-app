  ...
  return (
    <SafeAreaProvider>
      ...
      >
        ...
        <Stack.Screen name="auth/callback" options={{ title: "ログイン処理", headerShown: false }} />
        ...
        <Stack.Screen name="chat/index" options={{ title: "チャット", headerShown: false }} />
        <Stack.Screen name="chat/[id]" options={{ title: "チャット", headerShown: false }} />
        ...
        <Stack.Screen name="partner-posts/[id]/edit/index" options={{ title: "募集を編集", headerShown: false }} />
        <Stack.Screen name="partner-posts/[id]/requests/index" options={{ title: "参加希望一覧", headerShown: false }} />
